...
Robe::Robe(float x, float y, int width, int height, int lvl)
  ...
  switch (lvl) {
    ...
    case 1: {
      player_t.loadFromFile(resourcePath() + "files/images/halat_1.png");
      arm = 1;
      break;
    }

    case 2: {
      player_t.loadFromFile(resourcePath() + "files/images/halat_2.png");
      arm = 2;
      break;
    }

    case 3: {
      player_t.loadFromFile(resourcePath() + "files/images/halat_3.png");
      arm = 3;
      break;
    }
