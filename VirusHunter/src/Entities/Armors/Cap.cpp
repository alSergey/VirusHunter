...
Cap::Cap(float x, float y, int width, int height, int lvl)
  ...
  switch (lvl) {
    ...
    case 1: {
      player_t.loadFromFile(resourcePath() + "files/images/cap_1.png");
      arm = 1;
      break;
    }

    case 2: {
      player_t.loadFromFile(resourcePath() + "files/images/cap_2.png");
      arm = 2;
      break;
    }

    case 3: {
      player_t.loadFromFile(resourcePath() + "files/images/cap_3.png");
      arm = 3;
      break;
    }

    case 4: {
      player_t.loadFromFile(resourcePath() + "files/images/cap_4.png");
      arm = 4;
      break;
    }
